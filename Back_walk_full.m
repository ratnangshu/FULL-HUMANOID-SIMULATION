...
for t=1:25       %start
        ...
        [temp_left_joint_angles(2),temp_left_joint_angles(3)]=find_back_angles(centre_pelvis(1),3,centre_pelvis(3),0);
        temp_right_joint_angles(1)=temp_left_joint_angles(1);
        [temp_right_joint_angles(2),temp_right_joint_angles(3)]=find_back_angles(centre_pelvis(1),xa,centre_pelvis(3),height_ankle);
        ...
        right_arm=find_arm(centre_pelvis,left_hand_angles,1);
        left_arm=find_arm(centre_pelvis,right_hand_angles,0);
...
for m=1:no_of_steps
    for t=1:40    %left leg as swing one
        ...
        temp_left_joint_angles(1)=atan((centre_pelvis(2)-5)/h);
        [temp_left_joint_angles(2),temp_left_joint_angles(3)]=find_back_angles(centre_pelvis(1),xa,centre_pelvis(3),height_ankle);
        temp_right_joint_angles(1)=temp_left_joint_angles(1);
        [temp_right_joint_angles(2),temp_right_joint_angles(3)]=find_back_angles(centre_pelvis(1),3,centre_pelvis(3),0);
